                        ...
                        <v-item>
                            <v-card class="campanhas-cards" height="auto" width="200">
                                ...
                                <v-img class="influencer-card-img overflow-visible" :src="activeinfluencer.src" cover>
                                    <v-card-title class="card-influencer-title">{{ activeinfluencer.title }}</v-card-title>
                                </v-img>
                                <v-divider></v-divider>
                                <div class="influencer-card-btns">
                                    ...
                                    <v-img class="card-youtube-icon "
                                        ...
                                        v-for="item in activeinfluencer" :key="item.id" :value="activeinfluencer.id" @click="activeRow(value)">
                                        </v-btn>
                                    </v-img>
                        ...
                        <template v-if="index">
                            <v-expand-transition class="card-sidebar">
                                <v-card>
                                    ...
                                    <div class="influencer-card-btn">
                                        <v-btn class="contratar-btn" width="100px" color="blue-darken-1">Contratar</v-btn>
                                    </div>
                                </v-card>
                            </v-expand-transition>
                        </template>
